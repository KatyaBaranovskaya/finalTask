...
<div class="content">
    <div class="addContent">
        ...
        <h1 class="serviceH1"><fmt:message key="label.editService" bundle="${rb}"/></h1>
        <p class="line"></p>
        ...
        <div class="col-sm-7">
            <input type="text" class="form-control" name="typeService" value="${service.typeService}">
        </div>
    </div>
    <div class="form-group">
    ...
    <div class="form-group">
        <div class="col-sm-offset-2 col-sm-5">
                    <span class="btn btn-default btn-file">
                        ...
                        <input type="file" name="image" value=""><fmt:message key="label.browsePhoto" bundle="${rb}"/>
                    </span>
        </div>
    </div>
    <div class="form-group">
        <div class="col-sm-offset-3 col-sm-10">
            ...
            <button type="submit" name="edit" class="btn btn-success"><fmt:message key="label.change"
                                                                                   bundle="${rb}"/></button>
        </div>
    </div>
    </form>
